...
const AvatarImg = styled.div`
  height: 200px;
  width: 200px;
  background-image: url("https://lazord.netlify.com/img/me.jpg");
    ...
    return (
      <div>
                ...
                <Row>
                  ...
                  <Col xs={12} md={8}>
                    ...
                    <Introduce>
                      <li>
                        <strong>Age: </strong>
                        <p>{ab.node.frontmatter.age}</p>
                      </li>
                      <li>
                        <strong>Address: </strong>
                        <p>{ab.node.frontmatter.address}</p>
                      </li>
                      <li>
                        <strong>Email: </strong>
                        <p>{ab.node.frontmatter.email}</p>
                      </li>
                      <li>
                        <strong>Freelance: </strong>
                        <p>{ab.node.frontmatter.freelance}</p>
                      </li>
                    </Introduce>
                    <Actions>
                      <li>
                        <CVButton raised>Download CV</CVButton>
                      </li>
                      <li>
                        <ContactButton raised>Contact Me</ContactButton>
                      </li>
                    </Actions>
                  </Col>
                </Row>
        ...
        <Grid>
          <Row>
            <Col xs={12} md={10} mdOffset={1}>
              <AboutMe>{ReactHtmlParser(ab.node.html)}</AboutMe>
            </Col>
          </Row>
        </Grid>
      </div>
